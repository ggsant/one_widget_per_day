...
class WidgetsCards extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: PageView(
          ...
          children: contentWidgets.map((ContentWidgets contentWidgets) {
            return Padding(
                  ...
                  children: [
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset(contentWidgets.asset,
                            fit: BoxFit.cover),
                      ),
                    ),
                    Padding(
                    ...
                    Padding(
                      ...
                      child: Text(contentWidgets.text),
                    ),
                    Container(
